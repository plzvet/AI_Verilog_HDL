...
module sw_fnd_controller(
    ...
    fnd_digit_select_sw u_digit_select(
        .clk(clk),
        .reset(reset),
        .sel(w_sel)
    );

    digit_split_sw u_digit_split(
        .in_data(in_data),
        .mode(mode),
        .fnd_1(w_fnd_1),
        .fnd_2(w_fnd_2),
    ...
    fnd_digit_display_sw u_digit_display(
        .digit_sel(w_sel),
        .fnd_1(w_fnd_1),
        .fnd_2(w_fnd_2),
        .fnd_3(w_fnd_3),
