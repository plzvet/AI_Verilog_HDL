...
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports PWM_SERVO_LED]
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports PWM_OUT_LED]
