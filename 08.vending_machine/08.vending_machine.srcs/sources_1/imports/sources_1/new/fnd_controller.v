...
module digit_split(
    ...
    // fnd용 숫자 변환
    assign fnd_1 = (state == COFFEE) ? data[11:8] % 13 : 4'b0000;
    assign fnd_2 = (state == COFFEE) ? data[11:8] % 13 : 4'b0000;
    assign fnd_3 = (state == COFFEE) ? data[11:8] % 13 : data[7:0] % 10;
    assign fnd_4 = (state == COFFEE) ? data[11:8] % 13 : data[7:0] / 10;
...
module fnd_digit_display(
    ...
    reg [2:0] display_state; // display state : 
                             // 0 : IDLE FND 1, 
                             // 1 : IDLE FND 2, 
                             // 2 : IDLE FND 3, 
                             // 3 : IDLE FND 4, 
